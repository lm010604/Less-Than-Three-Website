...
const ROUTES = array(
    ...
    "/auditions" => "pages/auditions.php",
    "/#about" => "pages/index.php#about",
    "/#events" => "pages/index.php#events",
    "/performances" => "pages/performances.php",
    "/contact" => "pages/contact.php",
    "/contact/confirmation" => "pages/form-handler.php"
);
