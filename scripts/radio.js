document.addEventListener("DOMContentLoaded", function () {
  ...
  const songs = [
    ...
    { title: "Can't Catch Me Now - Olivia Rodrigo", url: "audio/hozier.mp3" },
    { title: "You're So Vain - Carly Simon", url: "audio/hozier.mp3" },
    ...
    { title: "Mr. Sandman - The Chordettes", url: "audio/hozier.mp3" },
    { title: "No Roots - Alice Merton", url: "audio/hozier.mp3" },
    { title: "Kings and Queens - Ava Max", url: "audio/hozier.mp3" },
